...
<ResponsiveContainer width="100%" height={300}>
  <BarChart data={[
    { name: mostFrequentCategory[0], count: mostFrequentCategory[1] },
    { name: leastFrequentCategory[0], count: leastFrequentCategory[1] }
  ]}>
    <XAxis dataKey="name" />
    <YAxis />
    <Tooltip />
    <Legend />
    <Bar dataKey="count" fill="#1a74e2" name="Most Frequent" />
...
<ResponsiveContainer width="100%" height={300}>
  <BarChart data={[
    { name: mostFrequentSubCategory[0], count: mostFrequentSubCategory[1] },
    { name: leastFrequentSubCategory[0], count: leastFrequentSubCategory[1] }
  ]}>
    <XAxis dataKey="name" />
    <YAxis />
    <Tooltip />
...
<ResponsiveContainer width="100%" height={300}>
  <BarChart data={[
    { name: mostFrequentSubSubCategory[0], count: mostFrequentSubSubCategory[1] },
    { name: leastFrequentSubSubCategory[0], count: leastFrequentSubSubCategory[1] }
  ]}>
    <XAxis dataKey="name" />
    <YAxis />
    <Tooltip />
    ...
    <Bar dataKey="count" fill="#e21a1a" name="Least Frequent" />
  </BarChart>
</ResponsiveContainer>
